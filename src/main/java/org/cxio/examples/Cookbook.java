...
public class Cookbook {
    ...
    private final static void customElementWriterAndReader() throws IOException {
        ...
        final List<AspectElement> cartesian_elements = new ArrayList<AspectElement>();
        cartesian_elements.add(new CartesianLayoutElement(0l, "12.0", "21.0", "1.0"));
        cartesian_elements.add(new CartesianLayoutElement(0l, "42.0", "23.0", "2.0"));
        cartesian_elements.add(new CartesianLayoutElement(0l, "34.0", "23.0", "3.0"));
