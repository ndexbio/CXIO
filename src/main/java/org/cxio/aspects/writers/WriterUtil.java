...
public final class WriterUtil {
    ...
    public static void writeAttributesElement(final JsonWriter w, final AbstractElementAttributesAspectElement e, final AspectKeyFilter filter) throws IOException {
    ...
    public static void writeAttributesElement(final JsonWriter w, final AbstractAttributesAspectElement e, final AspectKeyFilter filter) throws IOException {
        if ((filter == null) || filter.isPass(e.getName())) {
            w.writeStartObject();
            w.writeNumberFieldIfNotEmpty(AbstractAttributesAspectElement.ATTR_SUBNETWORK, e.getSubnetwork());
